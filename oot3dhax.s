...
@ This is where the saved LR is located in the stack-frame for KOR and CHNTWN(smaller stack-frame than the other regions).
.word ROP_POPR3_ADDSPR3_POPPC @ Stack-pivot to ropstackstart.
.word (ROPBUFLOC(ropstackstart) - (0x0ffffc58+0x4))
