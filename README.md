...
* Write payload.bin:   ctrclient-yls8 --serveradr={ipadr} "--customcmd=directfilerw 0x567890B1 0x1 0x1 0x4 0x1a 0x7 0x1000 0x0 2F007000610079006C006F00610064002E00620069006E000000 @payload.bin"
